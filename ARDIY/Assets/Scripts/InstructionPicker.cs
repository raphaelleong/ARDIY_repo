...
public class InstructionPicker : MonoBehaviour
{
  ...
  void Start ()
  {
    ...
    foreach (string[] ss in allInstr) {
      ...
      //Vector3 initialPos = instructionSets[count].transform.position;
      //int panelCount = 0;

      foreach (string instr in ss) {
        //Vector3 newPosition = new Vector3(initialPos.x + (panelCount * (instrPanelWidth + 10)), initialPos.y);
        ...
        //newInstr.transform.position = newPosition;
        //++ panelCount;
      }
